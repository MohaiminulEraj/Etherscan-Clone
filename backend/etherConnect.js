...
const connectEther = async (address) => {
    try {
        // If you don't specify a //url//, Ethers connects to the default 
        // (i.e. ``http:/\/localhost:8545``)
        console.log('address from connectEther: ', req)
        ...
        console.log(`Balance: ${ethers.utils.formatEther(balance)} Ether`.green.underline.bold)
...
const sendTransactions = async (req, res) => {
    try {
        ...
        const tx = {
            to: "0x6c9C2e393eaF4eaf5A8aC1C3b7fD59Eb729484f7",
